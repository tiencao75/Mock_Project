...
//     // Method to get all playlists (returns map with indices)
//     // std::map<unsigned int, std::shared_ptr<Playlist>> getAllPlaylists();

//     // // Method to create a new playlist with the given index and name
//     // void createPlaylist(unsigned int index, const std::string& name);

//     // // Method to delete a playlist by its index
//     // void deletePlaylist(unsigned int index);
...
//     /*
//     void writeDataToFileFormatted(const std::string& filename, const std::map<unsigned int, std::string>& data);
//     */
// };
